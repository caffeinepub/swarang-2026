...
export class Backend implements backendInterface {
    ...
    async getGoogleFormEmbedUrl(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoogleFormEmbedUrl();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setGoogleFormEmbedUrl(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setGoogleFormEmbedUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEventInfo(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEventInfo(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
